...
public class RecyclerViewBanner extends FrameLayout {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (first == last && currentIndex != last) {
                        currentIndex = last;
                        onPageSelectListener.pageSelect(currentIndex % mData.size());
                    ...
                    LogUtil.INSTANCE.i("RecyclerBanner", "first:" + first + " last:" + last);
                }
     ...
     * 设置itemLayoutRes
     */
    public void setItemLayoutResId(@LayoutRes int resId) {
        this.itemLayoutResId = resId;
    }
