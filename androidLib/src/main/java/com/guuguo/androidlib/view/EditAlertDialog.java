...
public class EditAlertDialog extends BaseAlertDialog<EditAlertDialog> {
...
//        window.setLayout(DisplayUtil.dip2px(200), ViewGroup.LayoutParams.WRAP_CONTENT); 
     ...
     */
    public EditAlertDialog titleLineColor(int titleLineColor) {
     ...
     */
    public EditAlertDialog titleLineHeight(float titleLineHeight_DP) {
     ...
     */
    public EditAlertDialog dividerColor(int dividerColor) {
