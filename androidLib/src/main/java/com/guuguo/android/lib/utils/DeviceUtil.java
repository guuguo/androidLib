...
public class DeviceUtil {
    ...
    public static final int getPhoneType() {
        TelephonyManager tm = (TelephonyManager) BaseApplication.getInstance().getSystemService(BaseApplication.getInstance().TELEPHONY_SERVICE);
    ...
    public static final String getPhoneNo() {
        TelephonyManager tm = (TelephonyManager) BaseApplication.getInstance().getSystemService(BaseApplication.getInstance().TELEPHONY_SERVICE);
        String result = null;
        if (CommonUtil.hasPermission(BaseApplication.getInstance(), Manifest.permission.READ_PHONE_STATE)
    ...
    public static final String getScreenDisplayID() {
        WindowManager wm = (WindowManager) BaseApplication.getInstance().getSystemService(BaseApplication.getInstance().WINDOW_SERVICE);
